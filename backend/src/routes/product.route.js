...
import { addProduct, getAllProduct, getProductById, deleteProduct, updateProduct } from '../controllers/product.controller.js';
...
router.get('/getProduct/:id', asyncHandler(getProductById))
